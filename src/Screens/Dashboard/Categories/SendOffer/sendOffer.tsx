...
const sendOffer = () => {
  ...
  return renderForm(
           ...
           <View style={{ height:'100%', width:'100%',position:'absolute', zIndex:2, backgroundColor:'#000000c0'}}>
               <View style={{height:'30%', width:'100%', backgroundColor:'#000000c0', zIndex:999}}>
                    <View style={{display:'flex', alignItems:'center', position:'absolute', flexDirection:'row',justifyContent:'center', top:'80%', width:'100%'}}>
                            <Image source={require('../../../../../assets/images/Jeremy.png')}
                                            style={{height:120, width:120, zIndex:999 }}
                            />            
                    </View>
               </View>
               <View style={{height:'70%', width:'100%', backgroundColor:'#FFFFFF', borderTopLeftRadius: 20, borderTopRightRadius: 20, display:'flex',flexDirection:'row', justifyContent:'center', alignItems:'center' }}>
                  <View style={{ height:'90%', width:'90%'}}>
                    <View style={{height:'50%', display:'flex', alignItems:'center', justifyContent:'center'}}>
                        <Text variant='subheader'>Send Offer to Chidi Michaels</Text>
                        <Text variant='xs'>Photographer</Text>
                        <View style={{display:'flex', flexDirection:'row'}}>
                            <Ionicons name='star' size={15} color='yellow' /> <Text variant='xs'>5.0</Text>
                        </View> 
                        <Text variant='header'>$100,000</Text>   
